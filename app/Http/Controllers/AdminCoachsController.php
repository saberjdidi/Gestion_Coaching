<?php namespace App\Http\Controllers;
	...
	class AdminCoachsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Cms Users Id','name'=>'cms_users_id','type'=>'datamodal','validation'=>'required','width'=>'col-sm-10','datamodal_table'=>'cms_users','datamodal_columns'=>'name,email','datamodal_size'=>'small'];
