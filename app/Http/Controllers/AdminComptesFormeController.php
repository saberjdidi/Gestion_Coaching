<?php namespace App\Http\Controllers;
	...
	class AdminComptesFormeController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Specialite","name"=>"specialite"];
			...
			$this->form[] = ['label'=>'Email','name'=>'cms_users_id','type'=>'datamodal','validation'=>'required','width'=>'col-sm-10','datamodal_table'=>'cms_users','datamodal_columns'=>'email','datamodal_size'=>'small'];
			$this->form[] = ['label'=>'Specialite','name'=>'specialite','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Specialite","name"=>"specialite","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
