<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsers1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Privileges','name'=>'id_cms_privileges','type'=>'datamodal','validation'=>'required','width'=>'col-sm-10','datamodal_table'=>'cms_privileges','datamodal_columns'=>'name','datamodal_size'=>'small'];
