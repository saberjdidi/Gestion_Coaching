<?php namespace App\Http\Controllers;
	...
	class AdminFormationsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Coach','name'=>'coachs_id','type'=>'datamodal','validation'=>'required','width'=>'col-sm-10','datamodal_table'=>'coachs','datamodal_columns'=>'nom,prenom'];
